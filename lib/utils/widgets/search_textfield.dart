...
import 'package:promociones/utils/widgets/Geocoding.dart';
...
class SearchMapPlaceWidget extends StatefulWidget {
  SearchMapPlaceWidget({
    ...
    this.placeholder = 'Buscar dirección',
...
class _SearchMapPlaceWidgetState extends State<SearchMapPlaceWidget> with TickerProviderStateMixin {
  ...
  */
  ...
  Future<dynamic> _makeRequest(input) async {
    String input2 = "";
    input2 = input.toString().replaceAll("#", " ");
    String url =
        "?input=$input2&key=${widget.apiKey}&language=${widget.language}";
    ...
    final host = '';
    Uri ur = Uri.parse('https://maps.googleapis.com/maps/api/place/autocomplete/json'+url);
